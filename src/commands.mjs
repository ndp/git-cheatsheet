...
export const translations = {
  ...
  vi:      {
    ...
    commands:  {
      ...
      "diff":               { "cmd": "diff", "docs": "Hiển thị các sự thay đổi chưa được thêm vào vùng chỉ mục." },
      "diff x":             {
      ...
      "rm x":               { "cmd": "rm <(các) tệp...>", "docs": "Xoá một tệp khỏi không gian làm việc và vùng chỉ mục." },
      "mv x":               { "cmd": "mv <(các) tệp...>", "docs": "Di chuyển một tệp trong không gian làm việc hoặc vùng chỉ mục." },
      "commit -a":          {
        "cmd":  "commit -a [-m 'msg']",
      ...
      "stash list":         { "cmd": "stash list", "docs": "Liệt kê các stash mà bạn hiện đang có." },
      "stash show":         {
        "cmd":  "stash show [<stash>]",
